...
import { PROVIDERS } from './common/llm.js'
import { fileURLToPath } from 'url'
import { join, dirname } from 'path'
import pool           from './common/db.js'
import { verifyGoogleToken, exchangeGoogleCode, signJwt, authMiddleware } from './common/auth.js'
import { OAuth2Client } from 'google-auth-library'
import { requireRole, requirePermission, requireNonStudent, PERMISSIONS } from './common/rbac.js'
import { runTradingAgent, executeTrade, validateTrade } from './tradebuddy/agent.js'
import { getToolsFromServer, testServer } from './common/mcp.js'
import { runPromptTemplate, validateTokens, parseTokens } from './tradebuddy/promptRunner.js'
import { runRebalance, getAgentPortfolioState, runScheduledRebalances, calcNextRun } from './tradebuddy/agentPortfolio.js'
import { startPromptScheduler } from './tradebuddy/scheduler.js'
import { log as audit } from './common/audit.js'
import { logError } from './common/errorLog.js'
import { sendPasswordResetEmail, sendSnapshotFailureEmail } from './common/email.js'
import { getAppSetting, setAppSetting, getAllAppSettings } from './common/appSettings.js'
import marketRouter                    from './tradebuddy/market.js'
import financialsRouter                from './tradebuddy/financials.js'
import { classRouter, leaderboardRouter, groupRouter } from './tradebuddy/classes.js'
import { ideasRouter }                    from './tradebuddy/ideas.js'
import { resolveAudience, parseAudienceDescription, executeCampaign, generateAIBody, resolveTokens } from './tradebuddy/campaigns.js'
